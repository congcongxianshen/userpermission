			...
			<div class="panel panel-default">
			  ...
			  <div class="panel-body">
				<form id="updateUserForm" role="form">
					<input  value="${user.id}" id="id" type="hidden">
				  ...
				  <button type="button" id="updateBtn" class="btn btn-success"><i class="glyphicon glyphicon-plus">修改</i>
				  </button>
				...
				$('#updateBtn').click(function(){
					...
					$.ajax({
						...
						success:function(result){
							...
							if(result.success){
									 layer.msg("修改用户成功", {time:2000, icon:6}, function(){
