...
<button type="button" onclick="removeUsersInfo()" class="btn btn-danger" style="float:right;margin-left:10px;"><i class=" glyphicon glyphicon-remove"></i> 删除</button>
...
<br>
 <hr style="clear:both;">
	...
	<script type="text/javascript" src="${APP_PATH }/js/role.js"></script>
